...
class="border-t-0 px-8 align-middle border-l-0 border-r-0 text-lg whitespace-nowrap p-4"
>
<span v-if="column.visa === 'LUNAS'" class="bg-green-100 text-green-800 font-bold me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400">
{{ column.visa }}
</span>
