<template>
  <tbody>
    <tr v-for="(column, idx) in columns" :key="idx">
      ...
      style="width: 50px"
      >
      <span class="bg-green-100 text-green-800 text-lg font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400">{{column.nama_supplier}}</span>
    </th>
    <td
...
<td
class="border-t-0 px-8 align-middle border-l-0 border-r-0 text-lg text-right whitespace-nowrap p-4"
>
