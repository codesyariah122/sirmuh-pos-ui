<template>
  ...
  <th
  scope="row"
  class="px-6 py-4 text-lg border-l-2 border-r-2 text-gray-900 font-medium"
  >
...
<td
class="border-t-0 px-6 align-middle border-l-2 border-r-2 text-lg border-l-2 border-r-2 whitespace-nowrap p-4 text-right"
>
{{ item?.tax > 0 ? `(${item.tax}%)&nbsp;${$format(item.tax_rupiah)}` : '-' }}
</td>
