      ...
      <div>
        <div class="flex justify-start space-x-0 py-6">
          ...
          <div class="shrink-0 w-60">
            ...
            :options="[{ id: null, text: 'Pilih Pelanggan' }, ...pelanggan]"
...
export default {
  ...
  methods: {
    ...
    async getPelangganLists() {
      ...
      getAllPages()
        .then((data) => {
          this.pelanggan = this.transformPelangganLists(data);
        })
        .finally(() => {
          setTimeout(() => {
