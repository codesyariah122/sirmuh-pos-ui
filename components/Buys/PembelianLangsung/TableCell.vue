<template>
  <tbody>
    ...
    >
    <span v-if="column.return === 'True'" class="bg-pink-100 text-pink-800 text-lg border-l-2 border-r-2 border-b-2 font-medium me-2 px-2.5 py-0.5 rounded">Di Return</span>
    <span v-else>-</span>
  </td>
