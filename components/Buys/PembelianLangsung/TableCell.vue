<template>
  <tbody>
    ...
    <td
    class="border-t-0 px-6 align-middle whitespace-nowrap p-4 text-center border-l-2 border-r-2 border-b-2"
    >
    <span v-if="column.return === 'True'" class="bg-pink-100 text-pink-800 text-lg border-l-2 border-r-2 border-b-2 font-medium me-2 px-2.5 py-0.5 rounded dark:bg-pink-900 dark:text-pink-300">Di Return</span>
    <span v-else>-</span>
  </td>

  <td
  class="border-t-0 px-6 align-middle text-lg border-l-2 border-r-2 border-b-2 whitespace-nowrap p-4 text-right"
  >
...
<td class="whitespace-nowrap p-8 text-lg border-l-2 border-r-2 border-b-2 text-center">
  <span
...
class="whitespace-nowrap text-lg p-4 border-l-2 border-r-2 border-b-2"
>
