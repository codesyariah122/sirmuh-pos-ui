...
<div>
  <ul class="w-80 text-sm font-medium bg-transparent">
    ...
    <li v-if="showBiaya" class="w-full py-4 mb-4">
      <div class="grid grid-cols-3 gap-0">
        <div>
    ...
    <li v-if="parseFloat(supplier?.saldo_hutang) !== 0">
      <div class="grid grid-cols-3 gap-0">
        <div>
      ...
      <div class="flex justify-start mb-4 py-2">
        <div>
          <div class="flex items-center p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
            ...
            <div>
              <span class="font-medium">Jumlah Saldo Hutang!</span> masih ada saldo hutang sebesar : {{saldo_hutang}}.
            </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    changeBayarDp(e) {
      ...
      const bayar = Number(e.target.value);
      const numberResult = parseInt(this.input.total.replace(/[^0-9]/g, ""));
      const kembali = numberResult - bayar;
    ...
    async getDetailSupplier() {
      ...
      if (data.success) {
        ...
        this.saldo_hutang = this.$format(result?.saldo_hutang);
        setTimeout(() => {
          this.loading = false;
        }, 500);
      }
    ...
    simpanPembelian(draft) {
      ...
      formData.append("kas_biaya", this.input.kas_biaya);
      ...
      formData.append("showDp", this.showDp);
      ...
      formData.append('showBiayaKas', this.showBiayaKas);
