<template>
  <div>
    <a
      ...
      ref="btnDropdownRef"
    >
      <div v-if="imageData === null" class="relative flex items-center block max-w-sm p-6 bg-white border border-gray-100 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-800 dark:hover:bg-gray-700">
        <span
        ...
        this.$api
          ...
          .then(({ data }) => {
            ...
            if (data.data.logins[0].user_token_login === this.token.token) {
              ...
              this.imageData = data?.data?.photo;
