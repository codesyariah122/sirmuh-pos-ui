<template>
  <div class="flex flex-wrap mt-4">
    <div class="w-full mb-12 px-4">
      <cards-card-table color="dark" title="DATA LAPORAN KAS" types="data-laporan-kas" queryType="DATA_LAPORAN_KAS"
        queryMiddle="data-laporan-kas" :headers="headers" :columns="items" :loading="loading" :success="success"
...
export default {
  ...
  methods: {
    ...
    deleteBarang(id) {
      this.loading = true;
      this.options = "delete-data-laporan-kas";
      deleteData({
        api_url: `${this.api_url}/data-laporan-kas/${id}`,
        token: this.token.token,
        api_key: process.env.NUXT_ENV_APP_TOKEN,
      })
        .then((data) => {
