<template>
  <div class="flex flex-wrap mt-4">
    <div class="w-full mb-12 px-4">
      <cards-card-table color="dark" title="DATA LAPORAN HUTANG" types="data-laporan-hutang"
        queryType="DATA_LAPORAN_HUTANG" queryMiddle="data-laporan-hutang" :headers="headers" :columns="items"
