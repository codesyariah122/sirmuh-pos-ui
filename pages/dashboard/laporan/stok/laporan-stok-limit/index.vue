<template>
  <div class="flex flex-wrap mt-4">
    <div class="w-full mb-12 px-4">
      <cards-card-table color="dark" title="LAPORAN STOK LIMIT" types="laporan-stok-limit" queryType="LAPORAN_STOK_LIMIT"
        queryMiddle="laporan-stok-limit" :headers="headers" :columns="items" :loading="loading" :success="success"
...
export default {
  ...
  methods: {
    ...
    deleteBarang(id) {
      this.loading = true;
      this.options = "delete-laporan-stok-limit";
      deleteData({
        api_url: `${this.api_url}/data-laporan-stok-limit/${id}`,
        token: this.token.token,
        api_key: process.env.NUXT_ENV_APP_TOKEN,
      })
        .then((data) => {
