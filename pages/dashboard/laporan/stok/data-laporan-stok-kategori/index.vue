<template>
  <div class="flex flex-wrap mt-4">
    <div class="w-full mb-12 px-4">
      <cards-card-table color="dark" title="DATA LAPORAN STOK" types="data-barang" queryType="DATA_LAPORAN_STOK"
        queryMiddle="data-barang" :headers="headers" :columns="items" :loading="loading" :success="success"
...
export default {
  name: "data-laporan-stok-kategori",
  layout: "admin",
  ...
  methods: {
    handleFilterBarang(param, types) {
      if (types === "data-laporan-stok-kategori") {
    ...
    deleteBarang(id) {
      this.loading = true;
      this.options = "delete-data-laporan-stok-kategori";
      deleteData({
