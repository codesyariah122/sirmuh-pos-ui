<template>
  <div class="flex flex-wrap mt-4">
    <div class="w-full mb-12 px-4">
      <cards-card-table color="dark" title="DATA TRANSFER POINT" types="data-transfer-point"
        queryType="DATA_TRANSFER_POINT" queryMiddle="data-transfer-point" :headers="headers" :columns="items"
...
export default {
  ...
  methods: {
    ...
    deleteBarang(id) {
      this.loading = true;
      this.options = "delete-transfer-point";
      deleteData({
        api_url: `${this.api_url}/data-transfer-point/${id}`,
        token: this.token.token,
        api_key: process.env.NUXT_ENV_APP_TOKEN,
      })
        .then((data) => {
