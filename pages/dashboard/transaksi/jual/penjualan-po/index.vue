...
export default {
  ...
  methods: {
    ...
    getPenjualanPo(page = 1, param = {}, loading) {
      ...
      const endPoint = `${this.api_url}/data-penjualan-po?page=${page}&view_all=${param.view_all}${param.date ? "&date_transaction=" + param.date :""}&pelanggan=${param.pelanggan ? param.pelanggan : ""}`
