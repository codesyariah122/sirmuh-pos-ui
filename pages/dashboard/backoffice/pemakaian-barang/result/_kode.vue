<template>
	<div class="flex flex-wrap">
		<div
		:class="`w-full ${routeName === 'kode' ? 'lg:w-12/12' : 'lg:w-8/12'} px-4`"
		>
		<cards-card-settings
		pageType="pemakaianBarang"
		link="pemakaian-barang"
		title="Pemakaian Barang"
		methodType="result"
		:type="type"
		pageData="/backoffice/pemakaian-barang"
		/>
	</div>
</div>
</template>
