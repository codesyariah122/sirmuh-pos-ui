<template>
  <div class="flex flex-wrap mt-4">
    <div :class="`${$nuxt.showSidebar ? 'w-full mb-12 ml-6' : 'max-w-full'}`">
      <cards-card-table
        color="light"
        title="Pengeluaran Trashed"
        :headers="headers"
        :columns="items"
        :loading="loading"
        :trashed="true"
        types="data-pengeluaran-trash"
 ...
 */
import { PENGELUARAN_TRASH_TABLE } from "~/utils/table-trash-pengeluaran";
...
export default {
  ...
  data() {
    return {
      ...
      success: null,
      message_success: "",
      headers: [...PENGELUARAN_TRASH_TABLE],
