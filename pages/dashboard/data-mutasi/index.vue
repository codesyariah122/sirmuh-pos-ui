<template>
  <div class="flex flex-wrap mt-4">
    <div class="w-full mb-12 px-4">
      <cards-card-table color="dark" title="DATA MUTASI" types="data-mutasi" queryType="DATA_MUTASI"
        queryMiddle="data-mutasi" :headers="headers" :columns="items" :loading="loading" :success="success"
