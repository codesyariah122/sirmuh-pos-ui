<template>
  <div class="flex flex-wrap mt-4">
    <div class="w-full mb-12 px-4">
      <cards-card-table color="dark" title="DATA PEMAKAIAN BARANG" types="data-pemakaian-barang"
        queryType="DATA_PEMAKAIAN_BARANG" queryMiddle="data-pemakaian-barang" :headers="headers" :columns="items"
