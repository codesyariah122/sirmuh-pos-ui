<template>
  <div class="flex flex-wrap mt-4">
    <div class="w-full mb-12 px-4">
      <cards-card-table color="dark" title="DATA HISTORY" types="data-history" queryType="DATA_HISTORY"
        queryMiddle="data-history" :headers="headers" :columns="items" :loading="loading" :success="success"
