<template>
  <div class="flex flex-wrap mt-4">
    <div class="w-full mb-12 px-4">
      <cards-card-table color="dark" title="DATA FOOTER NOTA" types="data-footer-nota" queryType="DATA_FOOTER_NOTA"
        queryMiddle="data-footer-nota" :headers="headers" :columns="items" :loading="loading" :success="success"
...
export default {
  ...
  methods: {
    ...
    deleteBarang(id) {
      this.loading = true;
      this.options = "delete-data-footer-nota";
      deleteData({
        api_url: `${this.api_url}/data-footer-nota/${id}`,
        token: this.token.token,
        api_key: process.env.NUXT_ENV_APP_TOKEN,
      })
        .then((data) => {
